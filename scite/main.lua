...
local function Error(msg) _ALERT(STR.Prompt..msg) end       -- error msgù

------------------------------------------------------------------------
-- simple check for extman, partially emulate if okay to do so
-- remove by scipm-tictactoe (because depend of scipm-extman)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
local function TicTacToe()
  scite_OnDoubleClick(HandleClick)
  scite_OnChar(HandleChar)
  scite.Open("")
  scite.MenuCommand(450) --> added by scipm-tictatoe => set monospace char ( http://lua-users.org/wiki/SciteMakeMonospace )
  buffer[STR.Sig] = true;
  local t = {}
...
-- --------------------------------------------------------------------------------------------------------------------------------
-- scipm.tictactoe namespace
-- --------------------------------------------------------------------------------------------------------------------------------
scipm.tictactoe = {}

-- scipm.tictactoe.start  (global)
-- -------------------------------------------------------------------------------
scipm.tictactoe.start = TicTacToe;
